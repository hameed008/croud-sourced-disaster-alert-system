...
import {
  FiMenu, FiX, FiHome, FiAlertTriangle, FiTool, FiFileText,
  FiShoppingCart, FiBarChart2, FiUser, FiLogOut
} from "react-icons/fi";
          ...
          <>
            ...
            <div className="hidden lg:flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-2 cursor-pointer">
                ...
                <span className="font-medium text-gray-700">John Doe</span> {/* Replace with dynamic username */}
              </div>
